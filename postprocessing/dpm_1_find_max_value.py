...
for i in range(1, 13):
    for j in ['a', 'b', 'c', 'd']:
        ...
        for _, row in df_basic.iterrows():
            ...
            # Find the corresponding file based on the component name and model.
        ...
        for i_1, (comp_name, data_str) in enumerate(data_strings):
            ...
            # Iterate over each pair of data and split the string using ";" to get size and cost.
