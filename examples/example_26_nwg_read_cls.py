...
#chp_fluid_small_hi_solar4_all_nwg.csv

#bhkw_groß+e_boi.csv
#bhkw_groß+solar+e_boi.csv
#bhkw_klein+e_boi_nwg.csv
#bhkw_groß+solar+boi+e_boi_nwg.csv

#bhkw_klein+solar+e_boi_nwg.csv
#bhkw_klein+solar+boi+e_boi_nwg.csv
