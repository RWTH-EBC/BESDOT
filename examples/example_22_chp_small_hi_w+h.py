...
env_22 = Environment(time_step=8)
project.add_environment(env_22)

# If the objective of the project is the optimization for building, a building
# should be added to the project.
bld_22 = Building(name='bld_22', area=200, bld_typ='Wohngebäude')

# Add the energy demand profiles to the building object
# Attention! generate thermal with profile whole year temperature profile
#bld_22.add_thermal_profile('heat', env_22)
#bld_22.add_elec_profile(2021, env_22)
#bld_22.add_hot_water_profile(env_22)

bld_22.demand_profile['heat_demand'] = [9, 10, 10, 9, 0, 10, 9, 10]
bld_22.demand_profile["elec_demand"] = [0] * 8
bld_22.demand_profile['hot_water_demand'] = [1, 0, 0, 1, 0, 0, 1, 0]
