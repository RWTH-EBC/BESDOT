...
env_24 = Environment(time_step=24)
...
post_pro.plot_four_lines(result_output_path, 'output_heat_chp',
                         ...
                         'input_heat_therm_cns', 'Heat from CHP',
                         'Heat from Boiler', 'Heat Demand', 'Hot Water Demand',
                         'Energy CHP', r'Power (kW)')
post_pro.plot_one_line(result_output_path, 'therm_eff_chp', 'Efficiency of CHP',
                       r'Efficiency', 1.05)
post_pro.plot_one_line(result_output_path, 'status_chp', 'Status of CHP',
                       r'Status', 1.05)
post_pro.plot_chp(result_output_path)
