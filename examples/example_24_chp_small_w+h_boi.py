...
env_24 = Environment(time_step=300)
...
post_pro.step_plot_two_lines(result_output_path, env_24.time_step,
                             'input_elec_e_grid',
...
post_pro.step_plot_four_lines(result_output_path, env_24.time_step,
                              'output_heat_chp',
...
post_pro.step_plot_four_lines(result_output_path, env_24.time_step,
                              ...
                              'Warmwasserbedarf',
                              'Energieerzeugung', r'Leistung (kW)', n=1.5)
post_pro.step_plot_one_line(result_output_path, env_24.time_step,
                            'therm_eff_chp',
                            'Thermische Effizienz', r'Effizienz', n=1.02)
post_pro.step_plot_one_line(result_output_path, env_24.time_step, 'status_chp',
                            'Status des BHKW', r'Status')
post_pro.step_plot_chp(result_output_path, env_24.time_step)
post_pro.step_plot_heat_demand(result_output_path, env_24.time_step)
post_pro.step_plot_chp_small_eff(result_output_path, env_24.time_step)
post_pro.step_plot_four_lines(result_output_path, env_24.time_step,
                              'input_elec_e_cns',
