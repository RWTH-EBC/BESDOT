...
env_16 = Environment(start_time=0, time_step=300)
...
post.step_plot_two_lines(result_output_path, env_16.time_step, 
                         ...
                         r'Leistung (kW)', 1.05)
'''
post.step_plot_solar_water_tes(result_output_path, env_16.time_step)
post.step_plot_three_lines(result_output_path, env_16.time_step,
...
'''
post.step_plot_solar_eff(result_output_path, env_16.time_step,
                         project.environment.temp_profile)
post.step_plot_solar_irr(result_output_path, env_16.time_step,
