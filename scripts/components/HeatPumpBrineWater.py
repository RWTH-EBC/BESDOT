...
associated with comp_type HeatPump is "brine_water_heat_pump." Currently,
...
class HeatPumpBrineWater(HeatPump):
    def __init__(self, comp_name, temp_profile, comp_type="HeatPumpBrineWater",
                 comp_model=None,
