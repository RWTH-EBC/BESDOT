...
the comp_name associated with comp_type SolarThermalCollector is "tube_solar_coll".
Currently, this approach is being used, with the possibility of exploring better
...
class SolarThermalCollectorTube(SolarThermalCollector):
    def __init__(self, comp_name, temp_profile, irr_profile,
                 comp_type="SolarThermalCollectorTube", comp_model=None,
