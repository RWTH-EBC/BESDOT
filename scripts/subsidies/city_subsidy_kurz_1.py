...
# csv_file_path_solar_coll = os.path.join(script_folder, '../..', 'data', 'subsidy', 'city_subsidy_solar_coll.csv')
subsidy_data = pd.read_csv(csv_file_path)
# subsidy_data_solar_coll = pd.read_csv(csv_file_path_solar_coll)
...
class CitySubsidyComponent(CitySubsidy):
    ...
    def add_cons(self, model):
        ...
        if self.component_name == 'SolarThermalCollector':
